...
label2idx = {"头": 0, "中": 1, "末": 2}
result['label_phase'] = result["label_phase"].apply(lambda x: label2idx[x])

# print(data['label_phase'].unique())
print(result)
...
targets = pd.DataFrame(result['label_phase'])
